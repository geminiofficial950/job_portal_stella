...
import type { AdzunaJobNormalized } from "@/lib/adzuna";
...
async function writeDiskCache(
  ...
  try {
    ...
    console.warn(`Adzuna cache write failed (${countryCode}):`, err);
  }
}
...
export function filterAdzunaJobs(
  jobs: AdzunaJobNormalized[],
  q?: string,
): AdzunaJobNormalized[] {
...
export function getAdzunaCacheMeta() {
